  ...
  <div className="card-3d relative">
   <div className="card-inner h-full min-h-[420px] rounded-2xl">
    <div
     ...
     onClick={onClick}
     className="card-front card-surface card-surface--archive group"
    >
     <div className="flex min-h-[180px] flex-1 items-center justify-center rounded-t-[14px] bg-sand">
    ...
    <div
     ...
     onKeyDown={onClick ? (e) => e.key === "Enter" && onClick() : undefined}
     onClick={onClick}
     className="card-back flex flex-col justify-center rounded-2xl border-2 border-theme bg-sand p-5"
    >
     <p className="mb-3 font-serif text-sm font-semibold text-ink">
      {archive.name}
     </p>
     {"books_count" in archive && archive.books_count != null && (
      <p className="mb-4 text-2xl font-serif font-medium text-accent">
